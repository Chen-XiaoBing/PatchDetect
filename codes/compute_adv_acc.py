...
def load_image(image_path: str, imagetype='ori'):
...
"""
patch-size=7 : attack_acc=0.101, normal_acc=0.9307
...
if __name__ == '__main__':
    ...
    adv_example_path = 'result/attack/image_specific/ResNet18/ResNet18_{}/'.format(
        patch_size)
    adv_examples, labels = load_image(adv_example_path,"ori")
