...
def main():
    ...
    for f in files:
        ...
        prob_grid, class_grid, voting_grid, pred = run_mdr(
...
'''
python detect/image_specific_mdr.py --arch resnet50 --patch-size 0.1 --ckpt data/models/resnet50_0.1/model_best.pth.tar
'''
